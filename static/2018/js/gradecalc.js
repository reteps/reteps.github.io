...
function add_grades() {
  ...
  var previous_grade =
    get_average(formal_grades) * pformal + get_average(informal_grades) * iformal;
  console.log(formal_grades);
  console.log(informal_grades);
  document.getElementById('previous_grade').innerHTML =
    'Estimate of previous grade - ' + previous_grade.toFixed(2);
  ...
  document.getElementById('new_grade').innerHTML =
    'Estimate of new grade - ' + new_grade.toFixed(2);
}
